...
def main():
    ...
    # V4 参数: empty, monotonicity, smoothness, corner_max, snake, merge_potential
    WEIGHTS_V4['empty'] = best['empty']
    WEIGHTS_V4['monotonicity'] = best['monotonicity']
    WEIGHTS_V4['smoothness'] = best['smoothness']
    WEIGHTS_V4['corner_max'] = best['corner_max']
    WEIGHTS_V4['snake'] = best['snake']
    WEIGHTS_V4['merge_potential'] = best['merge_potential']
    ...
    with open(LOG_FILE, 'w', newline='') as f:
        ...
        for game_id in range(12, NUM_GAMES+12):
            ...
            start = time.time()
            while True:
                action = get_best_action(game, depth=DEPTH, eval_func=evaluate_v4)
                if action is None:
                    break
